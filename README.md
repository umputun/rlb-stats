...
- `max_points` (optional, default `100`) unsigned integer from `1` to `255`, sets aggregate interval to return not more than specified amount of candles; ignored when `aggregate` is set
